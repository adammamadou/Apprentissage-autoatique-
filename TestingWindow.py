import sys
from PySide2.QtWidgets import QApplication, QWidget, QLabel, QPushButton, QFileDialog
...
from Iostream import neural_network_loader, saveColumn1Dataset
    ...
    def startTest(self) :
        if self.__networkLoaded :
            if self.__testFilepath :
                classPath = QFileDialog.getOpenFileName(self, "Class dictionary", "/home", "CSV Files (*.csv)")[0]
                if classPath :
                    dico = saveColumn1Dataset(classPath)
                else :
